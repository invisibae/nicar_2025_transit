...
```{r}
# Step 1: Install Java 21 via rJavaEnv
...
Sys.setenv(JAVA_HOME = "/Users/user/Library/Caches/org.R-project.R/R/rJavaEnv/installed/macos/aarch64/21")

# start rjava and allocate enough memory for r5r
options(java.parameters = "-Xmx10g")  # must be before .jinit()

rJava::.jinit()

rJava::.jcall("java.lang.System", "S", "getProperty", "java.version")
# Should return "21.x.x"
```
...
To visualize access we'll use a heat map.
